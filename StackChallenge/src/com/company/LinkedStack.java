...
public class LinkedStack { //the reason we created this class separately and not use the linkelist class for stack is because
    ...
    private LinkedList<Character> stack;  //this linkedlist is a doubly linked list. Note for stack doubly is not required
    ...
    public void printStack(){
        ListIterator<Character> listIterator = stack.listIterator();
